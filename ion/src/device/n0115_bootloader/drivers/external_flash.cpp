...
static void initGPIO() {
  ...
  GPIOA.MODER()->setMode(10, GPIO::MODER::Mode::Output);
  GPIOA.OTYPER()->setType(10, GPIO::OTYPER::Type::PushPull);
  GPIOA.OSPEEDR()->setOutputSpeed(10, GPIO::OSPEEDR::OutputSpeed::Low);
  GPIOA.PUPDR()->setPull(10, GPIO::PUPDR::Pull::None);
  GPIO(GPIOA).ODR()->set(10, true);
}
